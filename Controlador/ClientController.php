...
class ClientController
{
                            ...
                            <div class="col-md-3 card-group">
                                <div class="card">
                                    ...
                                    <div class="card-body p-2">
                                        <h5 class="card-title">' . $prod['nombre_producto'] . '</h5>
                                        <div>
                                            <button name="compra" data-toggle="modal" data-target="#regModal" class="btn btn-success">comprar</button>
                                            <button class="btn btn-primary" data-toggle="modal" data-target="#detalle' . $i . '">ver más</button>
                                        </div>
                                    </div>
                                </div>
    ...
    public static function getCat()
    {
        ...
        foreach($tabla as $resultados){
            echo '<li class="menu__item"><a class="menu__link text-white" href="index.php?action='. $resultados['idcatproducto'] .'"> ' . $resultados['nombre_categoria'] . '</a></li>';
        }
    }
    ...
    public static function searchProds()
    {
        if (isset($_POST['buscar'])) {
            if (is_string($_POST['buscar']) && !empty($_POST['buscar'])) {
                $search = $_POST['buscar'];
                $prods = producto::searchProds($search);
                if ($prods) {
                    if (isset($_SESSION['cliente'])) {
                # code...
                        $i = 1;
